...
export const FullAbout = () => {
    ...
    return(
        <div  className="   flex items-center justify-around flex-col md:flex-row px-[30px] py-[150px] lg:min-h-[100vh] from-slate-50 bg-white rounded-t-[50px] gap-5 to-slate-50">
