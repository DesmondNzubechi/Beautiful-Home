...
export const AboutHome = () => {
    ...
    return(
        <div  className="bg-gradient-to-b shadow-2xl mt-[850px] md:mt-[250px]  flex items-center justify-around flex-col md:flex-row px-[30px] py-[100px] lg:min-h-[100vh] from-slate-50 rounded-t-[50px] gap-5 to-slate-50">
        <div data-aos='fade-up' aos-data-duration='2000' className="max-w-[700px] flex flex-col gap-3 ">
            ...
            <p className="text-slate-700 font-fonty  text-[18px] md:text-[22px] ">Welcome to <strong>HomeBuilder</strong> , where dreams come to life and homes are crafted with passion and precision. As a premier real estate company, we take pride in our commitment to delivering exceptional properties that truly reflect the vision and aspirations of our clients. Whether you're looking for a custom-built masterpiece or a thoughtfully designed pre-built home, HomeBuilder is your trusted partner in turning your dream into a reality.</p>
