...
export const AboutHome = () => {
    ...
    return(
        <div  className="bg-gradient-to-b shadow-2xl mt-[850px] md:mt-[250px]  flex items-center justify-around flex-col md:flex-row px-[30px] py-[150px] lg:min-h-[100vh] from-slate-50 rounded-t-[50px] gap-5 to-slate-50">
