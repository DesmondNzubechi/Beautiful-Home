...
export const Userdashboard = () => {
    ...
    return(
      !newUser? navig('/login') :
       ...
       <FaUserCircle onClick={() => {logoutB? setLogoutB(false):setLogoutB(true)}} className="text-[50px] fixed top-5 right-5 bg-white  active:text-slate-900 text-slate-500   shadow-2xl rounded-full"/>
     ...
     <button onClick={signout} className='shadow-2xl text-slate-50 uppercase py-1 rounded shadow-2xl text-[20px]  '>Logout</button>
        ...
        <div className="grid gap-[20px] px-[40px] py-[10px] md:grid-cols-1  lg:grid-cols-2">
