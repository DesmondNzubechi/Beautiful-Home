    ...
    return(
     ...
     <div className=" overflow-x-auto flex justify-center flex-row gap-1">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-5">
        <button className="bg-green-500 rounded px-3  py-2 text-[15px] text-slate-50 font-semibold   ">Contact Agent</button>
        <button className="bg-slate-900 rounded px-3  py-2 text-[15px] text-slate-50 font-semibold   ">Request A Tour</button>
