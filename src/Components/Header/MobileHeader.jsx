...
const hideNav = () => {
    ...
    return(
        ...
        <div className="bg-slate-900 md:hidden px-[20px] gap-5 z-[5] items-center fixed top-0 w-full text-slate-50 flex flex-row justify-around py-[10px]  ">
            <div className="relative z-[1]  font-bold uppercase text-[20px]"><NavLink to='/' className='flex items-center flex-row' to='/'>Homebuilder<BsFillHouseCheckFill/></NavLink></div>
